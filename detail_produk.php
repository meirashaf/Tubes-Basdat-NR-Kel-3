                    ...
                    <div class="card rounded-3 mb-4">
                        <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="row text-center">
                                                <div class="col">
                                                    <div class="rounded" style="background-color: rgb(235, 235, 235);">
                                                        <h5 class="pt-2"><?php echo $Stok ?></h5>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 my-2">
                                                <div class="row d-flex justify-content-between">
                                                    ...
                                                    <div class="col-4">
                                                        <input id="form1" min="0" name="quantity" value="2" type="number" class="col form-control form-control-sm" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 my-2">
                                            ...
                                            <div class="col-12 my-2 d-flex justify-content-center">
                                                ...
                                                <button class="btn btn-outline-primary px-4">
                                                    ...
                                                    <a href="./pemesanan.html">Buy Now</a>
                                ...
                                <div class="col-md-3 col-lg-3 col-xl-12 d-flex justify-content-start mt-3">
                                    <h5 class="mr-2">Tambahkan Review</h5>
                                </div>
                                ...
                                <div class="col-md-3 col-lg-3 col-xl-12 d-flex justify-content-start mt-2">
